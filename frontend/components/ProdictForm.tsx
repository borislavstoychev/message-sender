...
function ProductForm(product: Product) {
  ...
  const [variantId, setVariantId] = useState(product.imageSrc);
  ...
  return (
    <div className="w-full">
      ...
      <button
        className="pt-3 pb-2 bg-fuchsia-950 text-white w-full mt-2 rounded-sm font-primary font-semibold text-xl flex justify-center items-baseline  hover:bg-fuchsia-900"
